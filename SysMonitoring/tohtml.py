...
# Paths to files
csv_file = '$HOME/Downloads/git/Scripts/SysMonitoring/SOD_EOD/SOD_EOD_System_Monitoring.csv'
...
with open('$HOME/Downloads/git/Scripts/SysMonitoring/SOD_EOD/ebody.html', 'w', encoding='ISO-8859-1') as file:
